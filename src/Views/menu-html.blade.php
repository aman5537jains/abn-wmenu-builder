						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									<label for="menu" class="selected-menu">Select the menu you want to edit1:</label>
													...
													<div class="accordion-section-content ">
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
                                                                <p  >
																	<label class="howto" for="custom-menu-item-url"> <span>Type</span>&nbsp;&nbsp;&nbsp;
																		<select  id='menu_item_cms_type' onchange="onSelectLinkType(this.value)" name="type" type="text" class="menu-item-textbox " >
                                                                            <option>Custom URL</option>
                                                                            <option>Cms Page</option>
                                                                            {{-- <option>Internal URL</option> --}}

                                                                        </select>
																	</label>
																</p>
                                                                <p  style='display:none' class="cmsPagesList">
																	<label class="howto" for="custom-menu-item-url"> <span>Pages</span>&nbsp;&nbsp;&nbsp;

																		<select id='menu_item_cms_page' onchange=" $('#custom-menu-item-url').val(this.value)" name="cms_page" type="text" class="menu-item-textbox " >
                                                                            <option value=''>Select</option>
                                                                            @foreach($cms as $id=>$page)
